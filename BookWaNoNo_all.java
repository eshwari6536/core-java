...
public void run() {
  synchronized (book) {
   System.out.println("Author is Starting book : " +book.getTitle() );
	 ...
	 e.printStackTrace(); } book.setCompleted(true);
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		 // Book object on which wait and notify method will be called
		  ...
		  BookReader eshwariReader=new BookReader(book);
		  ...
		  Thread eshwariThread=new Thread(eshwariReader,"Eshwari");
		  arpitThread.start();
		  johnThread.start();
		  eshwariThread.start();
